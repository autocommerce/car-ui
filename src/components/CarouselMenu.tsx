...
const carImages = [
    {
        ...
        title: 'Pure Power',
        description:
            'Discover our range of sports cars designed to deliver unrivalled performance. Experience adrenalin on every journey'
    },
    {
        ...
        description:
            'Drive in style and comfort with our luxury cars. A refined driving experience and sophisticated design for the most discerning drivers.'
    },
    {
        src: 'https://dfu7z1nf7ktq9.cloudfront.net/blog/20285/65f431858f4ce.webp',
        title: 'Classic Timelessness',
        description:
            'Immerse yourself in automotive history with our classic cars. Vintage charm and robust mechanics for lovers of tradition'
    }
];
...
export default function Carrousel() {
    ...
    return (
        <CarouselContainer>
            ...
            <NavigationButton onClick={handlePrev} sx={{ left: '10px' }}>
                {'<'}
            </NavigationButton>
            <NavigationButton onClick={handleNext} sx={{ right: '10px' }}>
                {'>'}
            </NavigationButton>
        </CarouselContainer>
    );
